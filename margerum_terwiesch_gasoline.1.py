...
print gas_gallons, 'gallons of gasoline produce approximately', carbon_dioxide_pounds, 'pounds of carbon dioxide, and'

barrels_of_crude_oil = gas_gallons/19
print barrels_of_crude_oil, 'barrels of crude are required to produce approximately', gas_gallons, 'gas gallons, '
